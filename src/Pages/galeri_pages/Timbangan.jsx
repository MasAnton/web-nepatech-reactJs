        ...
        <div class="w-full pb-12 px-4 flex flex-wrap justify-center xl:mx-auto">
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                ...
                src="../dist/img/galery/Massa/1.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/Massa/2.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/Massa/3.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/Massa/4.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/Massa/5.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/Massa/6.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/Massa/7.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/Massa/8.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/Massa/9.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="w-full pt-10 border-t border-slate-700">
          ...
          <p class="font-medium text-xs text-slate-500 text-center">
            PT.Nepatech Akurasindo Utama © Copyright 2023-2024. All Rights
            Reserved.
          </p>
        </div>
      </div>
