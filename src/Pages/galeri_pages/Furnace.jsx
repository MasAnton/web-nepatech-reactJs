          ...
          <div className="w-full pb-12 px-4 flex flex-wrap justify-center xl:mx-auto">
            <div className="p-6 md:w-1/2 lg:w-1/3">
              <div className="rounded-md shadow-md overflow-hidden">
                <img
                  ...
                  src="./dist/img/galery/Furnace/1.jpg"
                  alt="E-Commerce"
                  width="w-full"
                />
              </div>
            ...
            <div className="p-6 md:w-1/2 lg:w-1/3">
              <div className="rounded-md shadow-md overflow-hidden">
                <img
                  className="hover:scale-110 ease-in duration-150"
                  src="./dist/img/galery/Furnace/2.jpg"
                  alt="E-Commerce"
                  width="w-full"
                />
              </div>
            ...
            <div className="p-6 md:w-1/2 lg:w-1/3">
              <div className="rounded-md shadow-md overflow-hidden">
                <img
                  className="hover:scale-110 ease-in duration-150"
                  src="./dist/img/galery/Furnace/3.jpg"
                  alt="E-Commerce"
                  width="w-full"
                />
              </div>
            ...
            <div className="p-6 md:w-1/2 lg:w-1/3">
              <div className="rounded-md shadow-md overflow-hidden">
                <img
                  className="hover:scale-110 ease-in duration-150"
                  src="./dist/img/galery/Furnace/4.jpg"
                  alt="E-Commerce"
                  width="w-full"
                />
              </div>
            ...
            <div className="p-6 md:w-1/2 lg:w-1/3">
              <div className="rounded-md shadow-md overflow-hidden">
                <img
                  className="hover:scale-110 ease-in duration-150"
                  src="./dist/img/galery/Furnace/5.jpg"
                  alt="E-Commerce"
                  width="w-full"
                />
              </div>
            ...
            <div className="p-6 md:w-1/2 lg:w-1/3">
              <div className="rounded-md shadow-md overflow-hidden">
                <img
                  className="hover:scale-110 ease-in duration-150"
                  src="./dist/img/galery/Furnace/6.jpg"
                  alt="E-Commerce"
                  width="w-full"
                />
              </div>
            ...
            {/* <!-- <div className="p-6 md:w-1/2 lg:w-1/3">
              <div className="rounded-md shadow-md overflow-hidden">
                <img
                  className="hover:scale-110 ease-in duration-150"
                  src="./dist/img/galery/Furnace/7.jpg"
                  alt="E-Commerce"
                  width="w-full" />
              </div>
            </div>
            <div className="p-6 md:w-1/2 lg:w-1/3">
              <div className="rounded-md shadow-md overflow-hidden">
                <img
                  className="hover:scale-110 ease-in duration-150"
                  src="./dist/img/galery/Furnace/8.jpg"
                  alt="E-Commerce"
                  width="w-full" />
              </div>
            </div> --> */}
            <div className="p-6 md:w-1/2 lg:w-1/3">
              <div className="rounded-md shadow-md overflow-hidden">
                <img
                  className="hover:scale-110 ease-in duration-150"
                  src="./dist/img/galery/Furnace/9.jpg"
                  alt="E-Commerce"
                  width="w-full"
                />
              </div>
            ...
            <div className="p-6 md:w-1/2 lg:w-1/3">
              <div className="rounded-md shadow-md overflow-hidden">
                <img
                  className="hover:scale-110 ease-in duration-150"
                  src="./dist/img/galery/Furnace/10.jpg"
                  alt="E-Commerce"
                  width="w-full"
                />
              </div>
            ...
            <div className="p-6 md:w-1/2 lg:w-1/3">
              <div className="rounded-md shadow-md overflow-hidden">
                <img
                  className="hover:scale-110 ease-in duration-150"
                  src="./dist/img/galery/Furnace/11.jpg"
                  alt="E-Commerce"
                  width="w-full"
                />
              </div>
