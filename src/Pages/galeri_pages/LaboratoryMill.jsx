        ...
        <div class="w-full pb-12 px-4 flex flex-wrap justify-center xl:mx-auto">
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                ...
                src="../dist/img/galery/LabMill/1.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/LabMill/2.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/LabMill/3.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/LabMill/4.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
          <!-- <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/LabMill/5.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div> -->
          <!-- <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/LabMill/6.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div> -->
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/LabMill/7.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/LabMill/8.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/LabMill/9.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
          <!-- <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/LabMill/10.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div> -->
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/LabMill/11.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
          <div class="p-6 md:w-1/2 lg:w-1/3">
            <div class="rounded-md shadow-md overflow-hidden">
              <img
                class="hover:scale-110 ease-in duration-150"
                src="../dist/img/galery/LabMill/12.jpg"
                alt="E-Commerce"
                width="w-full" />
            </div>
          </div>
